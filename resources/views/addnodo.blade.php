...
@php
    ...
    <div class="container" style="padding-left: 150px;padding-top:10px;">
        ...
        @endif
        <form action="{{route('savenodo')}}" method="POST" id="formularionodo" name="formularionodo" class="form">
            @csrf
            <div class="form-group">
                <label for="nombre" class="form-label">Nombre del nodo</label>
                <input type="text" name="nombrenodo" id="nombrenodo" class="form-control" placeholder="Nodo" autocomplete="off">
                <span style="color: red;">@error('nombrenodo'){{ $message }}@enderror</span>
            </div>
            <div class="form-group">
                <label for="Transmisor" class="form-label">Tranmisor</label>
                <input type="text" name="transmisor" id="transmisor" class="form-control" placeholder="T00:CH-00" autocomplete="off">
                <span style="color: red;">@error('transmisor'){{ $message }}@enderror</span>
            </div>
            <div class="form-group">
                <label for="receptor" class="form-label">Receptor</label>
                <input type="text" name="receptor" id="receptor" class="form-control" placeholder="R00:CH-00" autocomplete="off">
                <span style="color: red;">@error('receptor'){{ $message }}@enderror</span>
            </div>
            <div class="form-group">
                <label for="coordenadas" class="form-label">Coordenadas</label>
                <input type="text" name="coordenadas" id="coordenadas" class="form-control" placeholder="00.000000,-00.00000" autocomplete="off">
                <span style="color: red;">@error('coordenadas'){{ $message }}@enderror</span>
            </div>
            <div class="form-group">
                <label for="distancia" class="form-label">Distancia</label>
                <input type="text" name="distancia" id="distancia" class="form-control" placeholder="00.00km" autocomplete="off">
