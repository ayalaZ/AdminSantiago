...
@php
    ...
    <div class="container" style="padding-left: 150px;padding-top:10px;">
        <h3>Agregar Historia</h3>
        <hr>
        @if (session('failed'))
            <div class="alert alert-danger">{{ session('failed') }}</div>
        @endif
        <form action="{{route('savehistoria')}}" method="POST" id="formulariohistorial" name="formulariohistorial" class="form">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="date" name="fecha" id="fecha" class="form-control" autocomplete="off" tabindex="3">
            ...
            <div class="form-group">
                ...
                <input type="text" name="solucion" id="solucion" class="form-control"
                    placeholder="Describa la solicion del problema" tabindex="5"  autocomplete="off">
