...
<div class="container" style="padding-left: 150px;padding-top:10px;">
    ...
    @endif
    <form action="{{ route('updateunidad',$unidad->id) }}" method="POST" id="formulariounidad" name="formulariounidad"
        class="form">
        @method('PUT')
        @csrf
        <div class="form-group">
            ...
            <input type="text" name="placa" id="placa" class="form-control" placeholder="Placa de la unidad"
                tabindex="1" required autocomplete="off" autofocus value="{{ $unidad->placa}}">
        ...
        <div class="form-group">
            ...
            <input type="text" name="marca" id="marca" class="form-control" placeholder="Escriba la marca de la unidad"
                tabindex="2" required autocomplete="off" value="{{ $unidad->marca }}">
        ...
        <div class="form-group">
            ...
            <textarea rows="5" cols="50" name="descripcion" class="form-control" id="descripcion"
                placeholder="Descripcion" tabindex="4" required autocomplete="off">{{ $unidad->descripcion }}</textarea>
